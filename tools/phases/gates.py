...
"""Phase gate implementation for the gate-check CLI."""
...
from _colors import ok, fail, warn, header, info, GREEN, RESET, SYM_OK
from codecome.config import ROOT
from phases.phase_1_gates import check_phase_1a, check_phase_1b, check_phase_1c
