    ...
    <div className="vortex-card rounded-xl p-5 transition-all hover:-translate-y-0.5 hover:shadow-2xl">
      ...
      <div className="mb-3">
        ...
        <div className="mt-1 text-sm text-gray-400">
          Question Owner: <span className="font-semibold text-white">{audit.question_owner_name ? `${audit.question_owner_name} (${audit.question_owner_is_llm ? 'AI' : 'Human'})` : 'None'}</span>
        </div>
        <div className="mt-1 text-sm text-gray-400">
